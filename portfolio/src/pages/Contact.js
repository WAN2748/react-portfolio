                ...
                <Row>
                    ...
                    <Col size='md-12'>
                        <h4 className="col-sm-12 ml-auto contact-btn text-center">
                            <a href="mailto:niera.w.a@gmail.com" target="blank">
                                ...
                                <p>Email: Niera.w.a@gmail.com</p>
                            </a>
                        </h4>
                    </Col>
                    <Col size="md-12">
                        <h4 className="col-sm-12 ml-auto contact-btn text-center">
                            <a className="text-decoration-none text-black" href="https://www.linkedin.com/in/winston-nieradka-811b65203/" target="blank">
                    ...
                    <Col size="md-12">
                        <h4 className="col-sm-12 ml-auto contact-btn text-center">
                            <a className="text-decoration-none text-black" href="https://github.com/WAN2748" target="blank">
